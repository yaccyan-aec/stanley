...
cd %RootPath%\app
%RootPath%\app\Console\cake Syslogs.CreateSyslog -p %1 -app %RootPath%\app 
REM %RootPath%\app\Console\cake Syslogs.CreateSyslog > %DataPath%/tmp/fts_createlog_%DATE%.log -app %RootPath%\app 
