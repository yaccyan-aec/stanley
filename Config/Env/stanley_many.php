...
define('VALUE_default_database' 	, 'stanley_many');
 ...
 */
define('MY_DATA', '/data/stanley/data/stanley_many');		// このアプリが使用するデータの基本パス
 ...
 */
 ...
 define('VALUE_Mail_FromKey','cat@jsy.ne.jp');	//!< @brief 送信者メールアドレス
 define('VALUE_Mail_FromVal','cat');	//!< @brief 送信者名
 // このサーバについては、port 25 でも 587 でも　username,password は不要（あるとエラーになる）
 // Config/email.php　の当該箇所をコメントアウトすること。
 define('VALUE_Mail_Host','mail2.jsy.ne.jp');		//!< @brief メールサーバHost 新サーバ
 define('VALUE_Mail_Port', 587);					//!< @brief メールサーバPort 25/587
 define('VALUE_Mail_Timeout',30);				//!< @brief タイムアウト
 define('VALUE_Mail_Username','cat@jsy.ne.jp');			//!< @brief ユーザ （いらないかも）
...
define("PAGE_TITLE", "StanleyFTS_many");	//!< @brief Title ＜必須＞
...
define('MAIL_SEL_PREFIX','FTS_Personal');		// 	本番
define('MAIL_SUBJECT_PREFIX','[FTS_Personal]');		// メール表題の先頭につける決まり文句
...
define('VALUE_PSCAN_JOB','o4');
define('VALUE_PSCAN_JOB_NAME','conv4');
