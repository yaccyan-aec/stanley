...
define('VALUE_default_database' 	, 'fts_stanley_test');
 ...
 */ 
define('MY_DATA', 'C:'.DS.'data'.DS.'fts_stanley');		// このアプリが使用するデータの基本パス
...
define('MAIL_SEL_PREFIX','FTS5_Stanley');		// 	本番
define('MAIL_SUBJECT_PREFIX','[FTS5_Stanley]');		// メール表題の先頭につける決まり文句
