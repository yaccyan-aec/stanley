...
define('VALUE_default_database' 	, 'fts_stanley_many_test');
 ...
 */
define('MY_DATA', 'C:'.DS.'data'.DS.'fts_stanley_many');		// このアプリが使用するデータの基本パス
...
Configure::write('VALUE_REMAIN_DISK_SPACE', '20GB');
...
define('VALUE_Mail_FromKey','web@aec-fts.net');	//!< @brief 送信者メールアドレス
define('VALUE_Mail_FromVal','fts3_aec');	//!< @brief 送信者名
...
define('VALUE_Package','FTS');		// 必須
Configure::write('VALUE_CompanyName',
		array(	'jpn' => 'スタンレー電気株式会社',
				'eng' => 'STANLEY ELECTRIC CO., LTD.'));

define('MAIL_SEL_PREFIX','FTS5_St_Many');		// 	本番
define('MAIL_SUBJECT_PREFIX','[FTS5_St_Many]');		// メール表題の先頭につける決まり文句
...
define('VALUE_TFG_MountBase', '/mnt/fts2/'); // FTS2 server からみたマウントベース
