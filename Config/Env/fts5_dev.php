 ...
 */
define('MY_DATA', '/data/vhost/aec-fts2/fts5_dev');		// このアプリが使用するデータの基本パス
...
define('DEBUG_View',true);					//!< @brief [F] for View debug 2014.04.21
...
define('VALUE_Mail_FromVal','fts5_DEV');	//!< @brief 送信者名 
...
// Copyright
//--------------------------------------------
define('MAIL_SEL_PREFIX','FTS5_DEV');		// 	本番
define('MAIL_SUBJECT_PREFIX','[FTS5 DEV]');		// メール表題の先頭につける決まり文句

define('VALUE_Copyright','Copyright (c) 2014- ASAHI ENGINEERING CO .,LTD. All Rights Reserved.');
define('VALUE_Package','FTS5_DEV');						//!< @brief パッケージ名  ＜必須＞
...
define('VALUE_default_database' 	, 'fts5_dev');
...
define('VALUE_test_database' 		, 'fts5_dev_test');
