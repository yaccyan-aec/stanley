...
/**
 * add start　
 * app/Config/bootstrap.php 内で Configure::write('debug',2)； 以上を設定すること
 * Env/xxxx.php の中では、DEBUG_LogSQL のみ見る
 */
       if (defined('DEBUG_LogSQL')) {
        	switch(DEBUG_LogSQL){
        		case 2:
	        		// debug モード 2 のときは詳細
    	    		$this->log($this->_queriesLog, LOG_DEBUG);
					$this->_queriesLog = array();
        			break;
        		case 1:
        			// それ以外なら
